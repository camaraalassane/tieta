...
class ConcourHistoriqueController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        // ⭐ Récupérer toutes les candidatures avec les nouvelles colonnes
        $candidatures = Candidature::where('concour_id', $concourId)
            ...
            ->map(fn($c) => [
                ...
                'email'         => $c->profil?->user?->email,
                'nina'          => $c->profil?->nina ?? '-',
                'prenom_pere'   => $c->profil?->prenom_pere ?? '-',
                'nom_mere'      => $c->profil?->nom_mere ?? '-',
                'prenom_mere'   => $c->profil?->prenom_mere ?? '-',
                'region'        => $c->profil?->region ?? '-',
