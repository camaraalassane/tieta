...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $service = Service::firstOrCreate(
            ...
            [
                'slug' => Str::slug('DTTIA'),
                'description' => 'Direction des Transmissions, des Télécommunications et l\'Informatique des Armées',
                'is_active' => true,
            ]
        );
        ...
        $this->command->info("✅ Superadmin Général: superadmin@superadmin.com");
        ...
        $associations = DB::table('service_users')->where('service_id', $service->id)->get();
        ...
        $this->command->info("Superadmin Général : superadmin@superadmin.com / 12345678");
