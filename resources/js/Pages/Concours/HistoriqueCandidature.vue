                        ...
                        <template #content>
                            ...
                            >
                                <div class="flex align-items-center gap-4">
                                    ...
                                    >
                                        <i
                                            class="pi pi-history text-white text-3xl"
                                        ></i>
                                    </div>
                                    <div>
                                        <h1
                                        ...
                                        >
                                            <i
                                                class="pi pi-chart-line text-emerald-500"
                                            ></i>
                            ...
                            >
                                <div class="flex-1 w-full">
                                    ...
                                    <small class="text-400 text-xs"
                                        >Vous pouvez sélectionner un concours
                                        actif ou inactif</small
                                    >
                                </div>
                            </div>
                        </template>
                                ...
                                <div class="flex-1 w-full">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        >
                                            ...
                                            <InputText
                                                v-model="searchQuery"
                                                placeholder="Nom, prénom, n° dossier, email, résultat..."
                                                class="w-full"
                                            />
                                        </IconField>
                                        <Button
                                    ...
                                    <small class="text-400 text-xs"
                                        >Recherche sur le nom, prénom, n° de
                                        dossier, email, résultat et motif</small
                                    >
                                </div>
                            </div>
                        </template>
                        ...
                        <template #title>
                            <div class="flex align-items-center gap-2">
                                ...
                                <span class="text-lg font-semibold"
                                    >Historique des candidatures</span
                                >
                                <span class="text-sm text-600 ml-auto">
                                    Total: {{ candidatures.total }} candidat(s)
                                </span>
                            </div>
                        </template>
                        <template #content>
                                    ...
                                    >
                                        ...
                                        <div class="grid">
                                            <div class="col-12">
                                                <div class="field">
                                                    <label
                                                        class="text-xs text-600 font-semibold"
                                                        >Motif /
                                                        Remarques</label
                                                    >
                                                    <div
                                                        class="p-2 bg-white dark:bg-gray-900 border-round-md shadow-sm"
                                                    >
                                                        <p class="text-sm m-0">
                                                            {{
                                                                slotProps.data
                            ...
                            <!-- Pagination -->
                            <div
                                class="flex align-items-center justify-content-center mt-4 gap-1 flex-wrap"
                            >
                                <Link
                    ...
                    <Card class="shadow-sm">
                        <template #content>
                            <div class="text-center py-8">
                                ...
                                >
                                    <i
                                        class="pi pi-folder-open text-4xl text-400"
                                    ></i>
                                </div>
                                <h3 class="text-xl font-semibold text-900 mb-2">
                                    Aucune candidature
                                ...
                                <p class="text-500">
                                    Ce concours ne contient aucune candidature
                                    pour le moment
                                </p>
                            </div>
                        </template>
