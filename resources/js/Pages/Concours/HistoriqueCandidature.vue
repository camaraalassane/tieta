...
.header-card {
    ...
    background: linear-gradient(to right, var(--color-primary-light), white);
}

.dark .header-card {
    background: linear-gradient(to right, rgba(16, 185, 129, 0.15), #1f2937);
}
