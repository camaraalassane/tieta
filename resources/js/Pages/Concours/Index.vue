    ...
    <app-layout>
        <div class="p-fluid px-4 md:px-6 lg:px-8">
            ...
            <div class="grid mb-6">
                <div class="col-12">
                    <Card
                        class="shadow-lg border-none overflow-hidden header-card"
                    >
                        <template #content>
                            <div
                            ...
                            >
                                <div class="flex align-items-center gap-4">
                                    <div
                                        class="w-16 h-16 header-icon border-round-xl flex align-items-center justify-center"
                                    >
                                        <i
...
/* ⭐ Bouton primaire PrimeVue (celui sans sévérité spécifique) */
:deep(
...
/* ⭐ Cards d'en-tête avec dégradé dynamique */
.header-card {
