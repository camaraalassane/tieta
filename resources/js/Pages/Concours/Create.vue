...
const diplomeOptions = ref([
    ...
    { label: "Maîtrise", value: "Maitrise", icon: "pi pi-book" },
    ...
    { label: "TS (Technicien de Santé)", value: "TS", icon: "pi pi-heart" },
    {
        label: "TSS (Technicien Supérieur de Santé)",
        value: "TSS",
        icon: "pi pi-heart-fill",
    },
    {
        label: "DES (Diplôme d'Études Spécialisées)",
        value: "DES",
...
<template>
    ...
    >
        <div
            class="flex align-items-center gap-3 p-3 header-card border-round-lg mb-4"
        >
            <div
                class="w-12 h-12 header-icon border-round-xl flex align-items-center justify-center"
            >
...
:deep(
        .p-button:not(.p-button-outlined):not(.p-button-text):not(
                .p-button-success
            ):not(.p-button-danger):not(.p-button-secondary):not(
                .p-button-info
            ):not(.p-button-warning)
    ) {
    background: var(--color-primary) !important;
    border-color: var(--color-primary) !important;
