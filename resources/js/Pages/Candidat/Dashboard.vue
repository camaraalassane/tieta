                    ...
                    <template #title>
                        <div class="card-header">
                            <div class="card-title">
                                <i
                                    class="pi pi-list text-emerald-500 dark:text-emerald-400"
                                ></i>
                                <span class="dark:text-white"
                                    >Suivi des dossiers</span
                                >
                            </div>
                            <Badge
                    ...
                    <template #content>
                            ...
                            >
                                ...
                                >
                                    <template #body="sp">
                                        <div class="cell-with-icon">
                                            <i
                                                class="pi pi-briefcase text-emerald-500 dark:text-emerald-400"
                                            ></i>
                                            <span
                                                class="truncate text-gray-800 dark:text-white"
                                            >
                                ...
                                >
                                    <template #body="sp">
                                        <div class="cell-with-icon">
                                            <i
                                                class="pi pi-building text-gray-400 dark:text-gray-500"
                                            ></i>
                                            <span
                                                class="truncate text-gray-800 dark:text-gray-300"
                                            >
                                                {{
                                                    sp.data.concour
                                                        ?.service_nom || "-"
                                ...
                                <Column header="Date">
                                    <template #body="sp">
                                        <div class="cell-with-icon">
                                            <i
                                                class="pi pi-calendar text-gray-400 dark:text-gray-500"
                                            ></i>
                                            <span
                        ...
                        <div class="mobile-only">
                            <div
                                ...
                                class="empty-state dark:text-gray-400"
                            >
                            ...
                            <div v-else class="mobile-list">
                                <div
                                    ...
                                    :key="c.id"
                                    class="mobile-card dark:bg-gray-800 dark:border-gray-700"
                                >
                                    <div class="mobile-card-header">
                                        <div
                                            class="mobile-card-icon bg-emerald-100 dark:bg-emerald-900/30"
                                        >
                                            <i
                                                class="pi pi-briefcase text-emerald-600 dark:text-emerald-400"
                                            ></i>
                                        </div>
                                    ...
                                    <div
                                        class="mobile-card-footer dark:border-gray-600"
                                    >
...
.dark :deep(.p-datatable-striped .p-datatable-tbody > tr:nth-child(even)) {
    background: #1a2332 !important;
}

.dark :deep(.p-datatable-striped .p-datatable-tbody > tr:nth-child(odd)) {
    background: #1e293b !important;
}
