                ...
                <section v-if="form.concour_id" class="mt-6 animate-fadein">
                    ...
                    <div class="grid">
                        ...
                        <div class="upload-wrapper">
                            <div class="flex align-items-center gap-2">
                                ...
                                <template v-else>
                                    ...
                                    <Button
                                        ...
                                        size="small"
                                        @click="
                                            removeFile('certificat_nationalite')
                                        "
                            ...
                            <!-- Ajout du nom du fichier ici -->
                            <small
                                class="file-info"
                                v-if="form.certificat_nationalite_name"
                            >
                                <i class="pi pi-file-pdf"></i>
                                {{ form.certificat_nationalite_name }}
                            </small>

                            <small
                                v-if="loadingFiles['certificat_nationalite']"
                        ...
                        <div class="upload-wrapper">
                            ...
                            <!-- CORRECTION ICI : Vérifie bien le nom de la variable dans ton form -->
                            <small
                                class="file-info"
                                v-if="form.demande_manuscrite_name"
                            >
                                <i class="pi pi-file-pdf"></i>
                                {{ form.demande_manuscrite_name }}
                            </small>
                            <!-- Si ta variable s'appelle vraiment demande_name, garde demande_name -->
...
/* ⭐ Masquer TOUT le contenu après le bouton de FileUpload */
